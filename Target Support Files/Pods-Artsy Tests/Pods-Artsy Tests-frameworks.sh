...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Forgeries/Forgeries.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/XCTest+OHHTTPStubSuiteCleanUp/XCTest_OHHTTPStubSuiteCleanUp.framework"
fi
